...
export const letter = {
  ...
  paragraphs: [
    ...
    'I want you to know that you’re the person I’d look for in every room, the first person I want beside me in my future plans, travels, and adventures. You’re the person I want to marry someday and build a life with.',
...
export const photos = [
  { src: '/photo-1.jpg', alt: 'The two of us', pos: '50% 42%' },
  { src: '/photo-2.jpg', alt: 'You', pos: '50% 32%' },
]
